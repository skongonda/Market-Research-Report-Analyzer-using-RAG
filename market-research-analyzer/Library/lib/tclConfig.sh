...
# installed.
TCL_PREFIX='D:/Lab Setup/market-research-analyzer/market-research-analyzer\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Lab Setup/market-research-analyzer/market-research-analyzer\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Lab Setup/market-research-analyzer/market-research-analyzer\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Lab Setup/market-research-analyzer/market-research-analyzer\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Lab Setup/market-research-analyzer/market-research-analyzer\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Lab Setup/market-research-analyzer/market-research-analyzer\Library\lib\tclstub86.lib'
